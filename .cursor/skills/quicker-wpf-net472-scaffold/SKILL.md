---
name: quicker-wpf-net472-scaffold
description: >-
  在本仓库中新建面向 Quicker 集成的 WPF net472 项目：目录布局（src、slnx、build.yaml、README）、
  csproj/App.xaml/AssemblyInfo 模板、HandyControl 主题与暗黑配色资源约定、参照同仓库其它示例目录。
  在用户要求新建 Quicker WPF 插件、net472 脚手架、或与「qka」同类任务时使用；编码规范须配合 skill
  `wpf-coding-standards`。
disable-model-invocation: true
---

# Quicker WPF net472 脚手架

开发一个 wpf net472 的程序，参考本仓库其他目录的结构。

**MVVM 与控件约定：** Read 并遵循 `.cursor/skills/wpf-coding-standards/SKILL.md`。
