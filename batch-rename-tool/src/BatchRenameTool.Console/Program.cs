...
namespace BatchRenameTool.Console
{
    class Program
    {
        ...
        static void TestCycleRename()
        {
            ...
            // Verify - files should be swapped
        ...
        static void VerifyFiles(List<BatchRenameExecutor.RenameOperation> operations)
        {
