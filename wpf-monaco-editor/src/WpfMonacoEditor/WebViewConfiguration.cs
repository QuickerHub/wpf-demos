...
namespace WpfMonacoEditor
{
    ...
    public class WebViewConfiguration
    {
        ...
        /// </summary>
        public const string DefaultVirtualHostName = "app.monaco.local";
        ...
        /// </summary>
        /// <param name="devServerUrl">Development server URL (default: http://localhost:5174)</param>
        /// <param name="virtualHostName">Virtual host name for local files (default: app.monaco.local)</param>
            ...
            string? webEntryFile = null)
        {
            ...
            DevServerUrl = Environment.GetEnvironmentVariable("WPF_MONACO_DEV_URL")
                        ?? devServerUrl
                        ?? DefaultDevServerUrl;
